    ...
    while True:
        ...
        while not valid_private_key:
           ...
           # decoded_private_key = bitcoin.decode_privkey(private_key, 'hex')
            ...
            decoded_private_key1 = "0000000000000000000000000000000000000000000000007cce5efdaccf6808"

        wif_encoded_private_key = bitcoin.encode_privkey(decoded_private_key1, 'wif')
        public_key = bitcoin.fast_multiply(bitcoin.G, decoded_private_key1)
